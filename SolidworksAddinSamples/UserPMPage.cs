...
namespace HymmaSampleAddin
{
	public class UserPMPage
	{
		...
		IPropertyManagerPageWindowFromHandle windowFromHandle1;
		...
		protected void CreatePropertyManagerPage()
		{
			...
			handler = new PMPHandler(addin);
			swPropertyPage = (IPropertyManagerPage2)solidworks.CreatePropertyManagerPage("Sample PMP", options, handler, ref errors);
